...
def main():
    ...
    grass.run_command('g.remove', flags='f' , type='vector', pattern='*') #delets old files to delete corrupted data
#load input data
    #sets basepath
    input_path = "C:/Users/jocho/Desktop/opengis/project/data/in" 
    inter_path = "C:/Users/jocho/Desktop/opengis/project/data/inter"
    out_path = "C:/Users/jocho/Desktop/opengis/project/data/out"
...
#    grass.run_command('v.db.addtable', map='c_tramstop',overwrite=True)
 #   grass.run_command('v.db.addtable', map='c_busstop',overwrite=True)

#patching bus and tram routes togheter:
    ...
    grass.run_command('v.db.addtable', map='tbstop',overwrite=True) #new layer doesnt seem to have a defaulttable
  #  grass.run_command('v.db.addtable', map='c_tbstop',overwrite=True) 

#exporting/importing to write features with cat 1 into seperate features -> otherwise 2 are cat 1
...
#exporting and then inporting splits features with the same cat into individual features
    #tram
...
#adds cost calue from center to stop in new column
    #tram
